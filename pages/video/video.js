...
Page({
  ...
  videoLook: function (e) {
    ...
    this.setData({
      chooesVideo: e.currentTarget.dataset.url
    })
    videoContext.seek(0);
    videoContext.play();
   ...
   * 
   */
  bindVideoScreenChange: function () {
    return false
  },
  ...
  uploadImg: function (e) {
    ...
    var index = e.currentTarget.dataset.idx
    this.upload1(this.data.c_id, typeList[index], index)
  },
  ...
  */
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      ...
      path: 'pages/video/video?c_id=' + that.data.c_id
    }
  }
})